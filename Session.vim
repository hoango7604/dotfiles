...
wincmd w
argglobal
if bufexists(fnamemodify("backup.sh", ":p")) | buffer backup.sh | else | edit backup.sh | endif
balt Dotfiles
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("~/dotfiles/restore.sh", ":p")) | buffer ~/dotfiles/restore.sh | else | edit ~/dotfiles/restore.sh | endif
balt ~/dotfiles/backup.sh
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
